...
def Attention(self, encoder_hidden_states, encoder_lenths, step_hidden_state):
    """
    ...
    context_vector = t.bmm(attention_vector, encoder_hidden_states)
    # context_vector [B, 1, hidden_size]
    return attention_vector, context_vector


def softmax_mask(self, corelation_vector, encoder_lenths):
